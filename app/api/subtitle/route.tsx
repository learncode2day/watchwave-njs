...
export async function GET(request: Request) {
  const parseTime = (timeString) => {
    ...
    // Split the seconds part into seconds and milliseconds
  ...
  // create an api that takes in a subtitle URL and returns an array of subtitle objects with start and end times
