...
const SearchResults = ({ isLoading, filteredData, query, totalPages, setPage, allData }: Props) => {
	return (
		<div className="z-10 mt-10 h-full w-full gap-4">
			...
			{filteredData.length > 0 ? (
				...
				<div className="fr xl w-full font-semibold text-zinc-300">No results found for &quot;{query}&quot;</div>
			) : null}
