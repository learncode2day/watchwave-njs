...
const getYtVid = async (
  ...
  const vid = await fetch(
    `https://api.themoviedb.org/3/${media_type}/${result.id}/videos`,
    options,
  );
  ...
  const formats: videoFormat[] = [
    ...y.player_response.streamingData.adaptiveFormats,
    ...y.player_response.streamingData.formats,
  ];
