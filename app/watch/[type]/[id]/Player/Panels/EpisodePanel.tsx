  ...
  return (
    ...
    >
      <div
        ...
        onClick={() => setEpisodePanelVisible(false)}
      />

      <div className="absolute bottom-24 right-5 z-20 h-1/2 w-full max-w-[350px] overflow-hidden rounded-2xl bg-black/80 text-white/70 shadow-xl backdrop-blur-2xl">
        <ScrollShadow
          hideScrollBar
            ...
            <div className="fc w-full items-start">
              <div className="fr w-full justify-start gap-2">
                <button
                  ...
                  className="rounded-lg bg-transparent p-2 text-xl hover:bg-white/10"
                >
                  <IoArrowBack />
                </button>
                <h2 className="font-bold text-white/50">
                  {result.seasons[displaySeason].name}
                </h2>
              </div>
              <Separator />
              <ul className="fc my-2 w-full items-start gap-2">
                ...
                {result.seasons[displaySeason].episodes.map((e: Episode, i) => (
                  <PButton
                    ...
                    primary={
                      i + 1 === episode && e.season_number === season + 1
                    }
                  >
                    <div className="fr gap-3">
                      <div className="fc size-7 rounded-lg bg-foreground-100 text-white/60">
