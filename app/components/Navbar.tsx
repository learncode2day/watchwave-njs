...
const Navbar = () => {
	...
	return (
		<div className="sm:fc pointer-events-none fixed z-20 hidden w-full bg-black/20 pl-10 px-7 backdrop-blur-xl sm:h-full sm:w-auto sm:bg-transparent sm:backdrop-blur-none standalone:pt-10">
