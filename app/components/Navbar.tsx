...
const Navbar = () => {
  ...
  return (
    <div className="pointer-events-none fixed z-20 w-full bg-black/20 px-10 backdrop-blur-xl sm:h-full sm:w-auto sm:bg-transparent  sm:backdrop-blur-none standalone:pt-10">
